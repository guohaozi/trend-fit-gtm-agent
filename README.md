...
Current local verification: 95 Node tests pass via `npm test`; `npm run build` produces
...
- Editable `/workspace` flow for single-trend scoring, 3-trend shortlist ranking,
  evidence-gap guidance, provider dry-run / fixture commands, and Markdown export
